...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderModelComparisonTable() {
        ...
        const models = [
            { name: "Flux", average: 33.7, scores: [20.7, 8.0, 3.3, 69.2, 13.8, 63.3, 0.0, 15.4, 46.7, 31.0, 79.3, 72.4, 8.0, 10.7, 43.3, 60.0, 3.3, 6.7, 16.7, 0.0, 65.4, 40.0, 80.0, 30.8, 12.0, 55.2, 50.0] },
