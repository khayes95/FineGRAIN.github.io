...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderModelComparisonTable() {
        ...
        const models = [
            ...
            { name: "Nano Bannana", average: 37.80, scores: [37.93, 40.00, 0.00, 80.77, 25.00, 66.67, 3.45, 26.92, 48.28, 34.48, 65.52, 62.07, 8.33, 10.71, 46.67, 58.62, 6.67, 10.00, 20.00, 4.00, 88.46, 36.67, 72.00, 50.00, 12.50, 71.43, 36.67] },
        ...
        function renderModelComparisonTable2() {
            ...
            if (modelsData.length === 0) {
                modelsData = [
                    ...
                    { name: "Nano Bannana*", company: "Google", average: 37.80, scores: [37.93, 40.00, 0.00, 80.77, 25.00, 66.67, 3.45, 26.92, 48.28, 34.48, 65.52, 62.07, 8.33, 10.71, 46.67, 58.62, 6.67, 10.00, 20.00, 4.00, 88.46, 36.67, 72.00, 50.00, 12.50, 71.43, 36.67] },
                    { name: "Nano Bannana 2*", company: "Google", average: 40.55, scores: [48.28, 36.00, 3.33, 76.92, 13.79, 76.67, 0.00, 19.23, 53.33, 25.00, 68.97, 75.86, 44.00, 7.14, 40.00, 76.67, 3.33, 10.00, 20.00, 8.00, 96.00, 30.00, 84.00, 53.85, 16.00, 57.14, 60.00] },
